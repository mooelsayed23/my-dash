...
const EnhancedTable: React.FC<EnhancedTableProps> = ({ data }) => {
  ...
  return (
    <div className="w-full grow overflow-x-hidden sm:px-5 py-5  m-5 pt-0 text-nowrap p-3">
      <p className="text-4xl self-start mt-5 flex"><LiaStoreAltSolid className="icon" /> Product</p>
      <div className="shadow-xl shado mt-5 sm:px-3 md:px-8 py-8 pt-0 rounded-2xl overflow-x-auto">
